...
\begin{multicols*}{5}
    ...
    \underline{Eg.} Find all MRT stations that can be reached from NS1 in at most 3 stops \\
      \includegraphics[width=0.5\linewidth]{6_recursive_cte_eg.png}
    ...
    \begin{itemize}
      ...
      \begin{enumerate}
        ...
        \includegraphics[width=0.65\linewidth]{7_attribute_subtypes.png}
      \end{enumerate}
    ...
    \begin{itemize}
      ...
      \begin{multicols}{2}
        \includegraphics[width=1.0\linewidth]{9_ISA.png}
        \columnbreak
        \begin{enumerate}
